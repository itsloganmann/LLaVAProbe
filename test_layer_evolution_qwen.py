"""
Layer Evolution Analysis - Qwen3-VL - Run on 500 Images
...
try:
    ...
    BASE_DRIVE_DIR = "/content/drive/MyDrive/qwen_probe_runs"
    IS_COLAB = True
    print("🟢 Google Drive mounted successfully")
except Exception:
    BASE_DRIVE_DIR = "./qwen_probe_runs"
    IS_COLAB = False
...
print("="*70)
print("QWEN3-VL - LAYER EVOLUTION ANALYSIS")
print("="*70)
...
def main():
    ...
    from analysis.qwen_runner import Qwen3VLRunner
    
    device = "cuda" if torch.cuda.is_available() else "cpu"
    runner = Qwen3VLRunner(
        model_id="Qwen/Qwen2-VL-2B-Instruct",  # Qwen3-VL 2B model
        device=device,
    ...
    if IS_COLAB:
        ...
        print(f"   MyDrive/qwen_probe_runs/run_{timestamp}/")
    print("="*70)
